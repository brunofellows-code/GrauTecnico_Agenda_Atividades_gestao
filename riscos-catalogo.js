...
(function (w) {
  ...
  {p:3,i:3,s:"Pedagógico",r:"Pesquisa de satisfação não apurada ou sem retorno ao aluno no ciclo quinzenal",m:"Apuração quinzenal/semanal (nota); retorno em mural; Degustando com a coordenação",ind:"Apuração quinzenal não realizada; mural sem retorno; Degustando não executado"},
  ...
  {p:4,i:4,s:"CSA",r:"Caso de ouvidoria sem retorno ao aluno dentro de 48h",m:"Registro em ouvidoria e acionamento imediato de Pedagógico/Administrativo; prazo de 48h",ind:"Casos de ouvidoria sem retorno registrado em 48h; casos sem acionamento do Pedagógico/Administrativo"},
